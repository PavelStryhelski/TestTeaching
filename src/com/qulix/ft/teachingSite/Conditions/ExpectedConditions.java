...
package com.qulix.ft.teachingSite.Conditions;
...
public class ExpectedConditions {
  ...
  public static ExpectedCondition<WebElement> elementToBeClickable(
     ...
     */
    public static ExpectedCondition<WebElement> elementToBeEnabled(
            final By locator) {
        return new ExpectedCondition<WebElement>() {
  ...
  /**
   * @see #findElement(org.openqa.selenium.By, org.openqa.selenium.WebDriver)
   */
